...
namespace SliceFx.Wasi.Validation;

/// <summary>
/// Runs DataAnnotations validation for request models in the Slice WASI dispatch path.
/// </summary>
public static class WasiValidationRunner
{
    /// <summary>
