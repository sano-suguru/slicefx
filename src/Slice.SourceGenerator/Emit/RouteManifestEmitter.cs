...
internal static class RouteManifestEmitter
{
    ...
    {
        var className = assemblyName.Replace('.', '_') + "_SliceRouteManifest";
    ...
    private static void EmitRoutesField(StringBuilder sb, ImmutableArray<FeatureModel> features)
    {
        ...
        foreach (var feature in features)
        {
            ...
            sb.AppendLine($"            {BoolLiteral(IsWorkersCompatible(feature.ReturnTypeFqn))},");
    ...
    private static bool IsWorkersCompatible(string returnTypeFqn)
        => returnTypeFqn != "global::Microsoft.AspNetCore.Http.IResult"
