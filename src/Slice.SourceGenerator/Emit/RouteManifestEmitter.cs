...
internal static class RouteManifestEmitter
{
        ...
        ImmutableArray<ReferencedSliceModule> referencedModules)
    {
        ...
        {
            sb.AppendLine(
                $"[assembly: global::Slice.SliceAggregatedFeatureAssemblyAttribute({CSharpLiteral.String(assemblyName)})]");
        }
    }
        ...
        ImmutableArray<ValidatorModel> validators)
    {
        ...
        {
            sb.AppendLine(
                $"[assembly: global::Slice.SliceFeatureValidatorAttribute({CSharpLiteral.String(validator.RequestTypeFqn)}, {CSharpLiteral.String(validator.ImplementationTypeFqn)})]");
        }
    }
