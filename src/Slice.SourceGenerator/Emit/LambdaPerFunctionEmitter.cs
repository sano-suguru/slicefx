...
internal static class LambdaPerFunctionEmitter
{
        ...
        ImmutableArray<Diagnostic>.Builder diagnostics)
    {
        ...
        {
            "SLICE012" => Diagnostic.Create(descriptor, feature.GetDiagnosticLocation(), feature.TypeName, feature.ReturnTypeFqn),
            "SLICE015" => Diagnostic.Create(descriptor, feature.GetDiagnosticLocation(), feature.TypeName, ExtractParameterName(skip.Reason), ExtractParameterType(skip.Reason)),
            _ => Diagnostic.Create(descriptor, feature.GetDiagnosticLocation(), feature.TypeName),
        };
