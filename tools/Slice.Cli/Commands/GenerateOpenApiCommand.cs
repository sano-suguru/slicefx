...
internal static partial class GenerateOpenApiCommand
{
        ...
        string openApiVersion)
    {
        ...
        return new OpenApiDocument(
            ...
            new OpenApiInfo(
                title,
                version,
                $"Generated by `slice openapi` from the Slice route manifest for {ctx.AssemblyName}. " +
    ...
    private sealed record OpenApiDocument(
        ...
        [property: JsonPropertyName("x-slice-source")] string SliceSource,
        [property: JsonPropertyName("x-slice-omitted")] OpenApiOmittedRoute[]? OmittedRoutes);
    ...
    private sealed record OpenApiOperation(
        ...
        [property: JsonPropertyName("x-slice-portability")] string Portability,
        [property: JsonPropertyName("x-slice-portability-reason")] string? PortabilityReason);
