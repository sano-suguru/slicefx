...
internal sealed class TypeSchemaReader
{
        ...
        Dictionary<string, EnumSchemaInfo> enumsByType)
    {
        ...
        foreach (var typeHandle in reader.TypeDefinitions)
        {
            ...
            {
                throw new CliException($"Type '{fqn}' uses an unsupported System.Text.Json converter. The SliceFx CLI cannot safely project this type into a schema.");
            }
        ...
        foreach (var propHandle in type.GetProperties())
        {
            ...
            try
            {
                ...
                if (converter is JsonConverterKind.Unsupported)
                {
                    ...
                    throw new CliException($"Property '{typeName}.{propName}' uses an unsupported System.Text.Json converter. The SliceFx CLI cannot safely project this property into a schema.");
                }
