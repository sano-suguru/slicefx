...
namespace SliceFx.Cli.Templates;
...
internal static class FeatureTemplate
{
    ...
    internal static string Render(FeatureSpec spec)
    {
        ...
        var needsSliceUsing = !spec.RootNamespace.Equals("SliceFx", StringComparison.Ordinal)
                              && !spec.RootNamespace.StartsWith("SliceFx.", StringComparison.Ordinal);
