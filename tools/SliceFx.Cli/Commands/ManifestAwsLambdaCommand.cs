...
internal static partial class ManifestAwsLambdaCommand
{
        ...
        int timeout)
    {
        ...
        sb.AppendLine("AWSTemplateFormatVersion: '2010-09-09'");
        sb.AppendLine("Transform: 'AWS::Serverless-2016-10-31'");
        sb.AppendLine(CultureInfo.InvariantCulture, $"Description: '{YamlSingleQuoted($"Generated by slicefx manifest aws-lambda --mode function-per-feature --artifact-layout shared from {ctx.AssemblyName}. Edit as needed.")}'");
        sb.AppendLine();
